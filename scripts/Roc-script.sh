...
git_sparse_clone master https://github.com/kenzok8/openwrt-packages adguardhome luci-app-adguardhome luci-app-store luci-app-quickstart quickstart luci-lib-xterm luci-lib-taskd taskd
