...
git_sparse_clone IMM https://github.com/wwz09/IPQ_package   luci-app-store luci-app-quickstart quickstart luci-lib-xterm luci-lib-taskd luci-lib-iform taskd
