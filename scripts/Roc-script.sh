...
git_sparse_clone main https://github.com/mzwrt/mzwrt_package_Lite   luci-app-store luci-app-quickstart quickstart luci-lib-xterm luci-lib-taskd luci-lib-iform
