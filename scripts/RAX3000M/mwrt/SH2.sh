...
git_sparse_clone IMM https://github.com/wwz09/IPQ_package  luci-app-ikoolproxy luci-app-openclash luci-app-easymesh luci-app-ddnsto  luci-theme-argon luci-theme-design luci-app-design-config luci-app-argon-config luci-app-lucky luci-app-smartdns luci-lib-xterm luci-lib-taskd luci-lib-iform

git_sparse_clone IMM https://github.com/wwz09/IPQ_package  ucl upx taskd ddnsto filebrowser lua-maxminddb  smartdns upx-static docker lucky luci-app-homeproxy vlmcsd sing-box 
